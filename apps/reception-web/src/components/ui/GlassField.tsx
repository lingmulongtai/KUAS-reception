...
export function GlassField({
  ...
  return (
    <div
      className={clsx(
        'glass-panel glass-outline flex gap-5 rounded-3xl p-5 transition-all',
    ...
    >
      <div className="flex flex-col gap-1">
        ...
        {error ? <p className="text-xs font-semibold text-rose-500 dark:text-rose-300">{error}</p> : null}
      </div>
